#!/usr/bin/env python3
"""
scripts/site_head.html + scripts/site_app.js + site/data.json -> site/index.html

    python scripts/gen_data.py     # data/*.tsv -> site/data.json
...
if not data_path.exists():
    sys.exit("site/data.json missing — run scripts/gen_data.py first")
